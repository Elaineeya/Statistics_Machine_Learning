...
# Question 1 Daniel Bbernoulli


## 1a)


```{r, daniel_bernoulli1, echo = TRUE}
...
hist(posterior_sigma2, breaks = 100, main = "Posterior distribution of sigma^2", xlab = "sigma^2", freq = FALSE)
...
hist(G_samples,breaks = 100,  main = "Posterior distribution of G", xlab = "G", freq = FALSE)
...
# Question 3 Bayesian iinference for the concentration parameter in the von Mises distribution


## 3a)


```{r, bayesian_inference1, echo = TRUE}
# Required Libraries
library(REdaS)
# Data
...
```{r, bayesian_inference2, echo = TRUE}
# Posterior Mode
